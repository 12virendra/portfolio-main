                ...
                <div className='flex  w-full '>
                    <div className='w-full grid grid-cols-1 sm:grid-cols-2 gap-4 text-center py-8 '>
                        ...
                        <div className='  w-80  max-sm:w-[299px]   '>
                            ...
                            <a className=' ml-5 cursor-pointer hover:border-b-4 duration-500 text-pink-300 border-pink-300  text-lg ' href="https://12virendra.github.io/Password-generator/" target=''>LIVE</a>
                        </div>
